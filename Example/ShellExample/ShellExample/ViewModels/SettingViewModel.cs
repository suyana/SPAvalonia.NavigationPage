...
public class SettingViewModel : ViewModelBase {
    ...
    public SettingViewModel() {
        Transitions = new AvaloniaList<TransitionItem> {
            ...
            new TransitionItem
                { Name = "Windows EntranceNavigation", Transition = EntranceNavigationTransition.Instance },
            new TransitionItem
                { Name = "Windows DrillInNavigation", Transition = DrillInNavigationTransition.Instance },
            new TransitionItem
                { Name = "Windows ListSlideNavigation", Transition = ListSlideNavigationTransition.Instance },
        };
