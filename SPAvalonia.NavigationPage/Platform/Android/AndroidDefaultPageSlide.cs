...
namespace SPAvalonia.NavigationPage.Platform.Android;
...
public class AndroidDefaultPageSlide : PlatformBasePageTransition {
    ...
    protected override CompositionAnimationGroup GetOrCreateEnteranceAnimation(CompositionVisual element,
        double widthDistance, double heightDistance) {
    ...
    protected override CompositionAnimationGroup GetOrCreateExitAnimation(CompositionVisual element,
        double widthDistance, double heightDistance) {
        var compositor = element.Compositor;
    ...
    protected override CompositionAnimationGroup GetOrCreateSendBackAnimation(CompositionVisual element,
        double widthDistance, double heightDistance) {
        var compositor = element.Compositor;
    ...
    protected override CompositionAnimationGroup GetOrCreateBringBackAnimation(CompositionVisual element,
        double widthDistance, double heightDistance) {
        var compositor = element.Compositor;
    ...
    protected override Task RunAnimationAsync(
        ...
        return base.RunAnimationAsync(parentComposition, fromElement, toElement, forward, distance, heightDistance,
            cancellationToken);
    }
}